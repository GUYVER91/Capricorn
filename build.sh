...
cd $KERNEL_DIR
export ARCH=arm64
export CROSS_COMPILE="/home/guyver/Desktop/Toolchain/Linaro-v6.3.1/bin/aarch64-linux-gnu-"
export LD_LIBRARY_PATH=home/guyver/Desktop/Toolchain/Linaro-v6.3.1/lib/
